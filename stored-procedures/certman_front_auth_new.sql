USE [Service]
GO
/****** Object:  StoredProcedure [dbo].[certman_front_auth_new]    Script Date: 29.07.2026 18:15:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[certman_front_auth_new]
@pin 		varchar(50) 
AS
...
declare @kiosk_id_local int
declare @termtypeid int
declare @termtype varchar(50)
declare @termnumber varchar(50)
set @termtype = '1.terminal@forpay.ru'
set @kiosk_id_local =0 
...
'CN='+cer.common_name+',O='+ cast(cer.org_id as varchar(20))+',OU='+@termnumber+',S=msk,C=ru,L='+ cast(@kiosk_id_local as varchar(20)) +',E='+@termtype 'dn', @pin 'pin', 0 'code' from service..Certificates cer
