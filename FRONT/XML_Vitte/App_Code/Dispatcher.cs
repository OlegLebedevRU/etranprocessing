...
namespace XML_RyazanService
{
    ...
    public class Dispatcher : IHttpHandler
    {
		...
		string file_name = "vitte_";
                string sp_name = "Vitte_GetPayments";
...
if(col["from"]==null || col["to"]==null)
{
			sp_name = "Vitte_Dictionary";
			file_name+="dictionary.xml";
}
else
{
                ...
                DataSet ds = (DataSet)db.Execute(sp_name, CommandType.StoredProcedure, DBManager.DataReadType.DataSet, null, dt_from, dt_to, terminalNo);
