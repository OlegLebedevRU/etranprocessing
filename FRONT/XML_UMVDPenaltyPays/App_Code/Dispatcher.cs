...
namespace XML_GIBDD_Penalty
{
    ...
    public class Dispatcher : IHttpHandler
    {
		...
		int terminalNo =0;
                ...
                DataSet ds = (DataSet)db.Execute("UMVD_Penalty_GetPayments", CommandType.StoredProcedure, DBManager.DataReadType.DataSet, null, org_id, dt_from, dt_to, terminalNo);
