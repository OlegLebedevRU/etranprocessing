    ...
    public class Dispatcher : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext Context)
        {
            try
            {
                ...
                string sp_name = "RyazanGAZ_GetPayments";
                string function = col["function"]??"gaz";
                string pref = "GAZ_";
                ...
                DataSet ds = (DataSet)db.Execute(sp_name, CommandType.StoredProcedure, DBManager.DataReadType.DataSet, null, dt_from, dt_to);
