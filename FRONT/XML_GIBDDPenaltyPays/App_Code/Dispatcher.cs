...
namespace XML_GIBDD_Penalty
{
    ...
    public class Dispatcher : IHttpHandler
    {
		...
		int terminalNo =0;
                ...
                string file_name = "3000_" + org_id + "-" + dt_from.ToString("yyyyMMdd") + "-" + dt_to.ToString("yyyyMMdd") + ".xml";
                ...
                DataSet ds = (DataSet)db.Execute("GIBDD_Penalty_GetPayments", CommandType.StoredProcedure, DBManager.DataReadType.DataSet, null, org_id, dt_from, dt_to, terminalNo);
