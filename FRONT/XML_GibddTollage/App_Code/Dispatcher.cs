    ...
    public class Dispatcher : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext Context)
        {
            try
            {
                ...
                //col.Add("to", "2010-11-22");
                //col.Add("org_id", "1");

		int terminalNo =0;
                int tspCode = 0;
                if (col["tspCode"] != null)
                    tspCode = int.Parse(col["tspCode"]);
                ...
                string file_name = "GibddTollage-" + dt_from.ToString("yyyyMMdd") + "-" + dt_to.ToString("yyyyMMdd") + ".xml";
                ...
                DataSet ds = (DataSet)db.Execute("GibddTollage_GetPayments", CommandType.StoredProcedure, DBManager.DataReadType.DataSet, null, tspCode, dt_from, dt_to, terminalNo);
