...
> Результаты натурного исследования на хосте 87.242.100.34, сравнительные юнит-бюджеты и расчет емкости представлены в **[`etran_arch-l4media-resource-profiling-and-unit-budgets.md`](etran_arch-l4media-resource-profiling-and-unit-budgets.md)**.
