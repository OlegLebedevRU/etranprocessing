...
**Срез исходников:** 11.09.2026. Актуализировано по результатам синхронизации контрактов `ctl v1` (R1 / P0) между `iot-rpc-rest-app` (`app1`), `MenuBuilder` (BFF/UI) и `tools/l4desk`.
