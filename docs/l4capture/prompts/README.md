...
2. **Изоляция каталогов:**
   ...
   - Код, скрипты и результаты: `tools\l4capture\`.
...
| 11 | `L4C-11-RELEASE-PACKAGE` | Финальный дистрибутив x86/x64, лицензии, SBOM, инсталлятор, откат | `tools/l4capture` | `H-L4C-10-v1` | `H-L4C-11-v1` |
