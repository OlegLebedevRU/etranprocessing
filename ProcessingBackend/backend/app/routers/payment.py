...
async def payment(
    ...
    logger.info(f"Request: function={function}, ext_id={paym_ext_id}, terminal={terminal.sn}")
...
async def _handle_payment(params: dict, terminal: Terminal, db: AsyncSession) -> Response:
...
async def _handle_update(params: dict, terminal: Terminal, db: AsyncSession) -> Response:
