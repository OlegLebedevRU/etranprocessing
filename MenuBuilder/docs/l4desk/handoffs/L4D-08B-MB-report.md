...
## 7. Artifacts & Candidate Handoff Block (DETACHED_V1)

### 7.1. Перечень артефактов MenuBuilder
| № | Артефакт | SHA-256 |
| :-: | :--- | :--- |
...
| 14 | `MenuBuilder/docs/l4desk/handoffs/L4D-08B-MB-report.md` | *(рассчитывается побайтно после сохранения отчёта)* |

### 7.2. Размещение отдельного кандидата (DETACHED_V1)
...
`MenuBuilder/docs/l4desk/handoffs/L4D-08B-MB-candidate.md` (а также `MenuBuilder/docs/l4desk/handoffs/L4D-08B-MB-FIX-01-candidate.md`).
