...
- **Live Smoke Verification Output:**
  ```text
  1. /status -> 200 {'enabled': True, 'agent_release_url': 'https://l4tools-generic.ar.cloud.ru/l4tools/1.7.7/l4setup.exe', 'agent_version': '1.7.7'}
  2. /terminals -> status: 200 (Total count: 129, Sample item: id=1164, readiness: record=ready, certificate=pending, iot=pending, online=offline)
  3. /terminals (POST onboard) -> status: 201 (Onboarded terminal: terminal_id=3710, sn='SN-SMOKE-5F0428', ordinal=2, is_free=False, readiness: record=ready, certificate=issued, iot=ready, online=offline)
  4. /terminals/{id} (DELETE cleanup) -> status: 200 {'ok': True, 'message': 'Terminal SN-SMOKE-5F0428 deleted successfully', 'earliest_free_terminal_id': 3709}
  ```
...
producer_commit: 3a82f758f1f513511eb9c55b682e09ae2154366f
accepted_at_utc: 2026-09-19T13:30:00Z
...
deployment_environment: production-compose
deployment_host: 87.242.100.34
deployment_evidence:
  - "menubuilder-backend running on port 8000 (docker network 172.19.0.4:8000)"
  - "nginx-default serving built frontend dist on port 3000 and reverse proxying /api to menubuilder-backend"
  - "smoke verification confirmed: /api/settings/terminals/onboard/status 200, /api/settings/terminals 200, POST onboard 201, DELETE cleanup 200"
artifact_paths:
...
artifact_sha256:
  ...
  - 1547ea4cefce52a8b102e10b8ddeecacbeb45dee531798c16ce38ab882ab3853
