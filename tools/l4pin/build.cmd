...
cmd /c ""%VC_DIR%\vcvars32.bat" && rc.exe /nologo /fo obj\x86\app.res res\app.rc && cl.exe /nologo /O2 /MT /W4 /utf-8 /DUNICODE /D_UNICODE /D_CRT_SECURE_NO_WARNINGS /I src /Foobj\x86\ src\main.c src\url_finder.c src\http_client.c src\xml_utils.c src\cng_crypto.c src\cert_store.c obj\x86\app.res /link /OUT:bin\x86\l4pin.exe ncrypt.lib crypt32.lib winhttp.lib advapi32.lib shell32.lib user32.lib"
if errorlevel 1 (
...
cmd /c ""%VC_DIR%\vcvars64.bat" && rc.exe /nologo /fo obj\x64\app.res res\app.rc && cl.exe /nologo /O2 /MT /W4 /utf-8 /DUNICODE /D_UNICODE /D_CRT_SECURE_NO_WARNINGS /I src /Foobj\x64\ src\main.c src\url_finder.c src\http_client.c src\xml_utils.c src\cng_crypto.c src\cert_store.c obj\x64\app.res /link /OUT:bin\x64\l4pin.exe ncrypt.lib crypt32.lib winhttp.lib advapi32.lib shell32.lib user32.lib"
if errorlevel 1 (
