...
if exist "%REPO_TOOLS%\l4capture\bin\x86\l4capture.exe" (
    copy /y "%REPO_TOOLS%\l4capture\bin\x86\l4capture.exe" "%STAGING%\l4capture\bin\x86\l4capture.exe" >nul
)
if exist "%REPO_TOOLS%\l4capture\bin\x64\l4capture.exe" (
    copy /y "%REPO_TOOLS%\l4capture\bin\x64\l4capture.exe" "%STAGING%\l4capture\bin\x64\l4capture.exe" >nul
)
if exist "%REPO_TOOLS%\l4capture\idle_refresh.ini" (
    copy /y "%REPO_TOOLS%\l4capture\idle_refresh.ini" "%STAGING%\l4capture\bin\idle_refresh.ini" >nul
)
