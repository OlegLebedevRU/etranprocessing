...
echo.
echo [2/3] Building and running test_ctl_protocol.exe...
cl.exe /nologo /O2 /MT /W4 /utf-8 /D_CRT_SECURE_NO_WARNINGS /DWIN32_LEAN_AND_MEAN /I src /Foobj\ tests\test_ctl_protocol.c src\ctl_protocol.c src\json_min.c src\desktop_state.c src\display_inventory.c src\input_inject.c src\dedup_cache.c src\ffmpeg_cmdline.c src\ffmpeg_supervisor.c src\log.c /link /OUT:bin\test_ctl_protocol.exe ws2_32.lib winhttp.lib advapi32.lib user32.lib wtsapi32.lib ole32.lib oleaut32.lib gdi32.lib
if errorlevel 1 (
