...
**Статус:** Предшествующая альфа-редакция (заменена финальным архитектурным релизом). Документация перенесена в целевую папку `docs\l4capture`.  
**Цель документа:** предварительная модель замены FFmpeg в desktop-трансляции L4Desk. Утверждённый архитектурный релиз с каскадом агентов и регламентом контроллера см. в [docs/l4capture/l4capture_arch_final.md](../../../docs/l4capture/l4capture_arch_final.md). Копия этой альфа-записки в целевой папке: [docs/l4capture/l4capture_arch_alfa.md](../../../docs/l4capture/l4capture_arch_alfa.md).
