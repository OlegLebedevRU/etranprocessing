...
**Статус:** предложение для архитектурного решения  
**Цель документа:** зафиксировать целевую модель замены FFmpeg в desktop-трансляции L4Desk, сохранить совместимость существующей orchestration и RTP ingress, обеспечить работу на разнородных Windows-терминалах, включая Windows 7.
