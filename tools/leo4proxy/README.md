...
- **Контекстное меню по правому клику**:
  ...
  - **Селектор управления**: пункты «■ Остановить прокси», «▶ Запустить прокси», «🔄 Перезапустить прокси».
  - **Блок Информация**:
    - «ℹ Информация и сертификат...» — модальное окно с деталями сертификата, SN, сроком действия и адресами.
    - «🌐 Открыть /_leo4/info в браузере» — быстрый переход к локальному JSON API.
    - «📋 Скопировать Device SN в буфер» — копирование серийного номера в буфер обмена Windows.
  - **Управление окном**: скрыть / показать окно консоли («👁 Скрыть/Показать окно консоли»).
  - **Выход**: корректное завершение работы прокси и удаление иконки из трея.
