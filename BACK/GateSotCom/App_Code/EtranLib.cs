namespace EtranLib
{
    ...
    namespace Xml
    {
        ...
        class XmlClass
        {
            ...
            static public void InsertInnerText(XmlDocument xmldoc, XmlNode xmlnode, Hashtable InnerText)
            {
                foreach (DictionaryEntry myDE in InnerText)
                {
                    string name = myDE.Key.ToString();
