namespace EtranLib
{
    ...
    namespace Crypto
    {
        ...
        public class Crypto
        {
            ...
            static public byte[] HashAndSign(string msg, ref X509Certificate2 cert)
            {
                RSACryptoServiceProvider rsa_private = cert.PrivateKey as RSACryptoServiceProvider;
                HashAlgorithm SHA1 = HashAlgorithm.Create("SHA1");
                //return Convert.ToBase64String(rsa_private.SignHash(SHA1.ComputeHash(Encoding.UTF8.GetBytes(msg)), CryptoConfig.MapNameToOID("SHA1")));
                return rsa_private.SignHash(SHA1.ComputeHash(Encoding.UTF8.GetBytes(msg)), CryptoConfig.MapNameToOID("SHA1"));
            }
