 ...
 * Main.java
 *
 * Created on 21 Сентябрь 2006 г., 14:14
 *
 * Пример осуществляет проверку номера в платежной системе CyberPlat.Com
 * 
 */
...
public class Main {
    ...
    /** Путь к ключам */
    private static final String KEYS="/home/shocker/java";
     ...
     */
    String sendRequest(String url,String number,double amount) throws IPrivException,IOException
    {
    ...
    public static void main(String[] args) {
        ...
        try
        {
            ...
            String resp=m.sendRequest("http://payment.cyberplat.ru/cgi-bin/es/es_pay_check.cgi","8888888888",12.5);
            System.out.println(resp);
        }
        catch(Exception e)
        {
