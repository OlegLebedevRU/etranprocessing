...
**Единственный разрешённый scope изменений:** `l4desk-service` (приёмка — только `l4desk-service/docs/prompts/contract-handoff.md`; явно согласованная регистрация corrective — документы в `l4desk-service/docs/prompts`).
