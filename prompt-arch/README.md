# Архитектурные промпты и черновики (Архив)

Все материалы, черновики, промпты и исследования из этого каталога систематизированы и перенесены в раздел истории активной разработки:
